 ...
 */
bool Uart3DmaTXIsWriteInProgress() {
 ...
 */
void Uart3DmaTXClearReadBuffer() {
 ...
 */
bool Uart3DmaTXHasReceiveBufferOverrun() {
 ...
 */
bool Uart3DmaTXIsTransmitionComplete() {
 ...
 */
void Uart3DmaTXInterruptHandler() {
