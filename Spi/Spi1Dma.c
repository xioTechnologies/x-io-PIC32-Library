...
const Spi spi1Dma = {
    .transfer = Spi1DmaTransfer,
    .transferInProgress = Spi1DmaTransferInProgress,
};
 ...
 */
void Spi1DmaTransfer(const GPIO_PIN csPin_, volatile void* const data_, const size_t numberOfBytes_, void (*transferComplete_)(void)) {
