 ...
 */
void Uart2DmaInitialise(const UartSettings * const settings, const UartDmaReadConditions * const readConditions, void (*read_)(const void* const data, const size_t numberOfBytes)) {
    ...
    DCH1ECONbits.CHSIRQ = _UART2_RX_VECTOR;
    ...
    DCH2ECONbits.CHSIRQ = _UART2_RX_VECTOR;
 ...
 */
void Uart2DmaWrite(const void* const data, const size_t numberOfBytes, void (*writeComplete_)(void)) {
