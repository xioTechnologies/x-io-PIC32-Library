 ...
 */
void Uart2DmaInitialise(const UartSettings * const uartSettings, const UartDmaReadConditions * const uartDmaReadConditions) {
    ...
    DCH3ECONbits.CHSIRQ = INT_VECTOR_UART2_RX;
    ...
    DCH3SSA = KVA_TO_PA(&U2RXREG); // source address
    ...
    DCH4ECONbits.CHSIRQ = INT_VECTOR_UART2_RX;
