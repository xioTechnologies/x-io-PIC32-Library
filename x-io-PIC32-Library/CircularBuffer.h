 ...
 */
static inline __attribute__((always_inline)) size_t CircularBufferGetReadAvaliable(CircularBuffer * const circularBuffer) {
...
static inline __attribute__((always_inline)) size_t CircularBufferRead(CircularBuffer * const circularBuffer, void* const destination, size_t numberOfBytes) {
    ...
    const size_t bytesAvailable = CircularBufferGetReadAvaliable(circularBuffer);
 ...
 */
static inline __attribute__((always_inline)) size_t CircularBufferGetWriteAvaliable(CircularBuffer * const circularBuffer) {
