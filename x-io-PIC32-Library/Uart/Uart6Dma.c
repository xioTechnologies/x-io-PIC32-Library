 ...
 */
void Uart6DmaInitialise(const UartSettings * const uartSettings, const UartDmaReadConditions * const uartDmaReadConditions) {
    ...
    U6MODEbits.PDSEL = uartSettings->parityAndData;
    U6MODEbits.STSEL = uartSettings->stopBits;
    ...
    DCH3ECONbits.CHSIRQ = INT_VECTOR_UART6_RX;
    ...
    DCH3SSA = KVA_TO_PA(&U6RXREG); // source address
    ...
    DCH4ECONbits.CHSIRQ = INT_VECTOR_UART6_RX;
