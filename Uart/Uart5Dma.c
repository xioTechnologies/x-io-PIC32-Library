 ...
 */
void Uart5DmaInitialise(const UartSettings * const settings, const UartDmaReadConditions * const readConditions, void (*read_)(const void* const data, const size_t numberOfBytes)) {
 ...
 */
void Uart5DmaWrite(const void* const data, const size_t numberOfBytes, void (*writeComplete_)(void)) {
 ...
 */
bool Uart5DmaHasReceiveBufferOverrun(void) {
    if (U5STAbits.OERR == 1) {
        U5STAbits.OERR = 0;
        return true;
    }
