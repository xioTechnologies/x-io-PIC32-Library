...
#ifdef _SPI3_TX_IRQ
    DCH0ECONbits.CHSIRQ = _SPI3_TX_IRQ; // channel transfer start IRQ
#else
...
#ifdef _SPI3_RX_IRQ
    DCH1ECONbits.CHSIRQ = _SPI3_RX_IRQ; // channel transfer start IRQ
#else
    DCH1ECONbits.CHSIRQ = _SPI3_RX_VECTOR; // channel transfer start IRQ
#endif
