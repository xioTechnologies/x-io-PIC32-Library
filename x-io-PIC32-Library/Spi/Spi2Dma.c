 ...
 */
void Spi2DmaInitialise(const SpiSettings * const spiSettings) {
    ...
    SPI2CONbits.CKP = spiSettings->clockPolarity;
    SPI2CONbits.CKE = spiSettings->clockPhase;
    SPI2BRG = SpiCalculateSpixbrg(spiSettings->clockFrequency);
    SPI2CONbits.ON = 1;
